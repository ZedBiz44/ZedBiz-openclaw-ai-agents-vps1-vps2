...
Date: 2026-09-02 MDT | Agent: Cody | Status: Completed
...
- `deploy-vps1-zknowledge-skills.sh` now deploys shared skills only to the managed root and removes any same-name workspace duplicate.
...
- All seven governed shared Z-Knowledge skills were eligible, model-visible, and sourced from `openclaw-managed` on every VPS1 agent.
