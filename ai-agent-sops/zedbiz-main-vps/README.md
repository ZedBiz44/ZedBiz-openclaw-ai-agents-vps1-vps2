...
- VPS1 OpenClaw agent containers use `mem_limit: 2g`, `memswap_limit: 2560m`, and `pids_limit: 2048` unless a tested agent-specific exception is documented. This is a ceiling, not a reservation; memory and swap limits remain the primary resource guardrails.
