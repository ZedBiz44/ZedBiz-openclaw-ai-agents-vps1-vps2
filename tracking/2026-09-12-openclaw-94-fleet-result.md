...
2026-09-12 MDT | Cody | VPS1 and Harry verified; Suzy and Frank in progress

## Scope and result

Jack authorized Terry and Harry first, then the remaining VPS1 OpenClaw agents, then Suzy and Frank after VPS1 finished. All eleven VPS1 agents and Harry now run the qualified 2026.9.4 release. Suzy and Frank are the remaining native VPS2 cutovers. Rocky and host reboots remain outside this deployment.
...
| Suzy | Pending | Pending | Native cutover in progress |
| Frank | Pending | Pending | Qualified native artifact prepared |
